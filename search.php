<?php 
    ...
    $str = mysqli_real_escape_string($conn, $_GET['str']);  // Storing id into variable

    //condition if user put negative id in url
    if($str != '' ) {
        $get_product = get_product($conn, '', '', '', $str);  //calling getproduct function and storing into variable
    }
    else { ?>
        <script>
